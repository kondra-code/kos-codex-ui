...
<Meta title="Foundations/3. Model Relationships" />
...
Use the `kosui model --name color --singleton --container` command to create a new model. This will handle colors to display.
...
Create a hook to use the color model in a component via `kosui hook -i`.
