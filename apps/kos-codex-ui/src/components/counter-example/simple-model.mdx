...
This will guide you through the steps to generate a new model and include much of the boilerplate needed to use it within the application.
...
Create a hook to consume the model with `kosui hook -i`.

This will guide you through the steps to generate both a hook and a Higher-Order Component (HOC) in order to access the model.
